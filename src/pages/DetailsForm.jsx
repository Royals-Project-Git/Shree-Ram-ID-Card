...
const FIELD_META = {
  ...
  AdmissionNumber:      { label:'Admission No.',      icon:'🔢', type:'text',     required:false },
  RollNumber:           { label:'Roll No.',           icon:'🎯', type:'text',     required:false },
  EmployeeID:           { label:'Employee ID',        icon:'🪪', type:'text',     required:false },
  ContactNumber:        { label:'Contact No.',        icon:'📱', type:'tel',      required:false },
  ...
  AadhaarNumber:        { label:'Aadhaar No.',        icon:'🪪', type:'text',     required:false },
  AadharCard:           { label:'Aadhaar No.',        icon:'🪪', type:'text',     required:false },
